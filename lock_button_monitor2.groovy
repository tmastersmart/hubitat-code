...
definition(
    name: "Lock Button Monitor V1.2",
    namespace: "tmaster",
    author: "tmaster",
    description: "Triggers when outside button locks the door for 2nd lock",
    category: "Convenience",
	iconUrl: "",
    iconX2Url: "",
    iconX3Url: "",
    importUrl: "https://raw.githubusercontent.com/tmastersmart/hubitat-code/main/lock_button_monitor2.groovy"
)
