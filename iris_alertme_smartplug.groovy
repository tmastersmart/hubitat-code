...
NOTE: This is a drop in replacement to uprade drivers
in the field to the new version without the alarm
if you need the alarm function please install v3

this code is the same as v2 code. 
