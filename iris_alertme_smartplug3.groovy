...
Noice: changes in hubitat breaks this code on the new dashboard
so a new version has been released without the alarm type
this version should only be used with alarms

I can not change the name or it would break current installs. 
...
metadata {
	definition (name: "Iris v1 Smart Plug custom with alarm", namespace: "tmastersmart", author: "Tmaster", importUrl: "https://raw.githubusercontent.com/tmastersmart/hubitat-code/main/iris_alertme_smartplug3.groovy") {
