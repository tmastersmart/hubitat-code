...
===================================================================================================
1.4.0    03/23/2023 Hub update broke automatic min volt test. Moved to a setting
...
preferences {
   ...
   input name: "minVoff",type: "enum", title: "Min Voltage",description: "Using minVoltTest set the min voltage your sensor will run on", options: ["1.9","2.0","2.1","2.2","2.3","2.4","2.5"], defaultValue: 2.2 ,required: true  
...
if (evt.name == "batteryVoltage"){//Event: [name:batteryVoltage, value:2.9]
    ...
    if (minVoff){minVolts = minVoff} // this replaces automatic setting
